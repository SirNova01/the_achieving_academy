            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title-2">
                        ...
                        <p> Hi <?= $_SESSION['email'] ?>, <br> your email address has been successfully verified. <br> please proceed to login into your account.  </p>
                        <a href="sign_in" class="main-btn">Login</a>
                    </div>
                </div>
